...
const CustomStyle = () => {
	...
	return (
		<div className="w-auto max-w-4xl px-4 mx-auto  rounded-xl flex flex-col items-center">
				...
				<div className="w-full max-w-xl mx-auto px-4">
					<div className="mb-6">
						<label htmlFor="nombreNegocio" className="block text-base md:text-lg font-semibold mb-2">
							Nombre de Negocio
						</label>
						<input
							type="text"
					...
					<div className="mb-6">
						<label htmlFor="categoria" className="block text-base md:text-lg font-semibold mb-2">
							Categoría
						</label>
						<select
							id="categoria"
					...
					<div className="mb-6">
						<label htmlFor="descripcion" className="block text-base md:text-lg font-semibold mb-2">
				...
				<div className="w-full max-w-xl mx-auto px-4 py-6">
					<div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-6">
						<ButtonCustomWhite text="Omitir" className="w-full sm:w-auto" />
						<ButtonCustom text="Guardar Perfil" className="w-full sm:w-auto" />
					</div>
				</div>
